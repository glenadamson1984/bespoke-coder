...
const Home: NextPage = () => {
  return (
    <div style={{backgroundImage: `url("/iStock-1274394138.jpg")`,         backgroundPosition: 'center',
      backgroundSize: 'cover',
      backgroundRepeat: 'no-repeat',
      width: '100%',
      height: '100%'}} className={styles.container}>
      <Head>
      ...
      <footer className={styles.footer}>
          <span className={styles.logo}>
            <Image src="/LinkedIn-COVER-Image.jpg" alt="Modern Software Logo" width={600} height={100} />
          </span>
      </footer>
    </div>
  )
